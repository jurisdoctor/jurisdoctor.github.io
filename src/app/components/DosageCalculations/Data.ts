...
export const Household: RowType[] = [
  ...
  { left: "1 fluid ounce (fl oz)", right: "2 tablespoons (Tbsp)" },
  { left: "1 fluid ounce (fl oz)", right: "6 teaspoons (tsp)" },
...
export const Rules: RuleType[] = [
  ...
  },
  {
    ...
    steps: [0.125, 0.25, 0.5, 1, 2, 4, 5, 10],
  },
  {
    group: "Metric",
    family: "mass",
  ...
  },
  {
    ...
    family: "volume",
    from: { value: 1, unit: "L" },
    to: { value: 100, unit: "cL" },
    steps: [1, 2, 3, 5],
  },
  {
    group: "Metric",
    family: "volume",
    from: { value: 1, unit: "dL" },
    to: { value: 100, unit: "mL" },
    steps: [1, 2, 3, 5],
  },
  {
    group: "Metric",
